        ...
        <div className='col-span-4 bg-blue-gray-400 rounded-tl-3xl border-r-4 border-black p-10'>
            ...
            <div className=''>
                {conversations.map((conver) => {
                    return (
                        <div onClick={() => handleConversationClick(conver.id)} key={conver.id} className={`flex flex-row items-center gap-4 my-2 rounded-full px-2 py-2 hover:cursor-pointer hover:bg-blue-gray-300 duration-500 ${conver.id === curentConversation ? 'bg-blue-gray-300' : 'bg-white'}`}>
